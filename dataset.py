...
df['Data'] = pd.to_datetime(df['Data'])  # Se a coluna 'data' estiver em formato de string
df['Quantidade Vendida'] = pd.to_numeric(df['Quantidade Vendida'], errors='coerce')  # Converte para numérico
df['Preço Unitário'] = pd.to_numeric(df['Preço Unitário'], errors='coerce')  # Converte para numérico

# Agora, converta o DataFrame para um array numpy
dataset = df.to_numpy()
...
# Encontrar o produto com o maior valor total de vendas
